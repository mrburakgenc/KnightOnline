...
- `shared/infrastructure/network/PacketRouter` — opcode → handler map. Currently 10 opcodes bound (chat × 2, item-repair, promotion, home × 2, party-bbs, stats × 2, party).
...
Last updated: Phase 3.10 commit (Party).
